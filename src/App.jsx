...
import MultiStepFormStepper from "./Components/MultiStepFormStepper";
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <>
                <HalfScroll />
<div ref={refP} id='parent' className=" h-[30vh] relative overflow-scroll my-24 bg-blue-300">
                <Reveal refP={refP} content={'Social Media Content'}/>
                <Reveal refP={refP} content={"Creative Strategy"} />
                <Reveal refP={refP} content={"Brand Strategy Development"} />
                <Reveal refP={refP} content={"Website Design"} />
                <Reveal refP={refP} content={"SEO (Search Engine Optimization)"} />
</div>       
              </>
            }
          ></Route>
