...
function MouseHoverTiltCard() {
  ...
  const rotateX = useTransform(mouseYSpring, [-0.5, 0.5], ["13deg", "-13deg"]);
  ...
  return (
    <motion.div
      ...
      className="relative w-[250px] h-[300px] bg-slate-500 rounded-xl flex justify-center items-center mt-[40px]"
    >
      <div
        style={{
          transformStyle: "preserve-3d", //bcoz effect is 3d using z transform,so necessary to add(must be added to all elements taking part in 3d effect/transformation)
        ...
        className="inset-4 bg-red-300 absolute rounded-xl flex flex-col gap-y-2 justify-center items-center shadow-lg"
      >
        <i
...
export default MouseHoverTiltCard;
